...
class train_select_both():
    def __init__(self):
        ...
        self.explore_startC = 1.0            # exploration probability at start
        self.explore_stopC = 0.01            # minimum exploration probability 0.01
        self.decay_rateC = 0.0001            # exponential decay rate for exploration prob 0.00001

         # Exploration parameters
        self.explore_startG = 1.0            # exploration probability at start
        self.explore_stopG = 0.01            # minimum exploration probability 0.01
        self.decay_rateG = 0.0001            # exponential decay rate for exploration prob


        # Network parameters
        self.hidden_size1C = 128               # number of units in each Q-network hidden layer 64
        self.hidden_size2C = 64
        self.hidden_size3C = 32
        self.learning_rateC = 0.000005        # Q-network learning rate 0.00001

         # Network parameters
        self.hidden_size1G = 128               # number of units in each Q-network hidden layer 64
        self.hidden_size2G = 64
        self.hidden_size3G = 32
        self.learning_rateG = 0.00001         # Q-network learning rate 0.00001

        

        # Memory parameters
        self.memory_sizeC = 10000             # memory capacity
        ...
        # Memory parameters
        self.memory_sizeG = 10000            # memory capacity
    ...
    def populate_memoryG(self):
        ...
        for _ in range(self.pretrain_lengthG):
            ...
            self.memoryGame.add((state, action, reward))
            ...
            for e in range(1, self.train_episodes+1):
                ...
                for i in range(4):
                    ...
                    if len(possible_games) > 0:
                        ...
                        explore_pG = self.explore_stopG + \
                            (self.explore_startG - self.explore_stopG)*np.exp(-self.decay_rateG*1000*e)
                ...
                if self.s.return_state_overall()['game'] != [None, None]:
                    ...
                    target_QsC = sess.run(self.QNetworkCard.output,
                                        feed_dict={self.QNetworkCard.inputs_: next_statesC}) #states})
